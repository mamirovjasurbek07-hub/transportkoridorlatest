...
export default function PublicMapPage() {
  ...
  const failedQuery = [query, countries, posts, corridors].find((item) => item.isError)
  ...
  const refreshAll = () => { void Promise.all([countries.refetch(), posts.refetch(), corridors.refetch(), query.refetch()]) }
