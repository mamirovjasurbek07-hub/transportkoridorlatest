...
class PostDailyMetric(Base, TimestampMixin):
    ...
    cargo_vehicles_entry: Mapped[int] = mapped_column(BigInteger, default=0)
    cargo_vehicles_exit: Mapped[int] = mapped_column(BigInteger, default=0)
    light_vehicles_entry: Mapped[int] = mapped_column(BigInteger, default=0)
    light_vehicles_exit: Mapped[int] = mapped_column(BigInteger, default=0)
    empty_wagons_entry: Mapped[int] = mapped_column(BigInteger, default=0)
    empty_wagons_exit: Mapped[int] = mapped_column(BigInteger, default=0)
    loaded_wagons_entry: Mapped[int] = mapped_column(BigInteger, default=0)
    loaded_wagons_exit: Mapped[int] = mapped_column(BigInteger, default=0)
